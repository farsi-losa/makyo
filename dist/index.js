...
const MyComponent = ({ text }) => {
    ...
    const [selectedSingleOpt, setSelectedSingleOpt] = React.useState('');
    const [options, setOptions] = React.useState(['option one', 'option two', 'option three', 'option four', 'option five']);
